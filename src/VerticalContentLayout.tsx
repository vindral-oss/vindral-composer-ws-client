...
export const VerticalContentLayout: React.FC<
  VerticalContentLayoutProps & { currentSelection?: UniqueSelection }
> = ({ audioObject, setCurrentSelectionFn, currentSelection }) => (
