...
export const SendMessage = React.memo(
  function SendMessage({
    ...
    const selectedAudioStripObject = useMemo(
      ...
      [audioStrips, selectedAudioStripName]
    );
  ...
  (prevProps, nextProps) => {
    // Only rerender if audioStrips reference changes, resetKey changes, or sendMessageFn changes
    const audioStripsEqual = prevProps.audioStrips === nextProps.audioStrips;
    const resetKeyEqual = prevProps.resetKey === nextProps.resetKey;
    const sendMessageFnEqual =
      prevProps.sendMessageFn === nextProps.sendMessageFn;

    const shouldSkipRerender =
      audioStripsEqual && resetKeyEqual && sendMessageFnEqual;
